...
def parse_args():    
    ...
    parser.add_argument('-epoch', type=int, default=100, help='max_epoch')
    ...
    parser.add_argument('-gpu_device', type=str, default="0", help='use which gpu')
    ...
    parser.add_argument('-xai_rt', type=int, default=1 , help='evaluation chunk')
    parser.add_argument(
    '-data_path',
    type=str,
    default='../data',
