...
class Sam(nn.Module):
    ...
    def forward_batch(
        ...
        # if current_epoch > self.args.epoch//2:
        #   epochRatio = (current_epoch-self.args.epoch//2)/(self.args.epoch//2)
        #   numSelectPts = int(np.round(10*(1-epochRatio)))
        #   if numSelectPts<2:
        #       numSelectPts = 2
        ...
        if current_epoch > self.args.epoch//4:
          epochRatio = (current_epoch+1)/(self.args.epoch)
